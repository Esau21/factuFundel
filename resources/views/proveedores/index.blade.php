            ...
            <div class="col-12">
                <div class="card h-100 d-flex flex-column">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Proveedores del sistema.</h5>
                        <div>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addProveedor">Agregar proveedor</button>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="sysconta-datatable" class="display cell-border stripe hover order-column"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-left">Nombre contacto</th>
                                        <th class="text-left">Contacto a cargo</th>
...
<script>
    $(document).ready(function() {
        $('#sysconta-datatable').DataTable({
            ...
            ajax: '{!! route('proveedores.getIndexDataProveedores') !!}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
