...
@section('content')
            ...
            <div class="col-12">
                <div class="card h-100 d-flex flex-column">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-primary btn-agregar-user" data-bs-toggle="modal"
    ...
    @include('users.modal.formadduser')
    @include('users.modal.formeditUser')
@endsection
...
<script>
    $(document).ready(function() {
        $('#sysconta-datatable').DataTable({
            ...
            ajax: '{!! route('usuarios.getDataUsersIndex') !!}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
            ...
            if (resultado.isConfirmed) {
                $.ajax({
                    ...
                    success: function(respuesta) {
                        Swal.fire({
                            title: 'El usuario se elimino con éxito',
                            icon: 'success'
                        }).then(() => {
