...
@section('title', 'Correlativos - Facturación')
@section('content')
            ...
            <div class="col-12">
                <div class="card h-100 d-flex flex-column">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Correlativos DTE.</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="sysconta-datatable" class="display cell-border stripe hover order-column"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-left">DTE</th>
                                        <th class="text-left">Codigo Establecimiento</th>
...
<script>
    $(document).ready(function() {
        $('#sysconta-datatable').DataTable({
            ...
            ajax: '{!! route('correlativos.correlativosDteIndexGetData') !!}',
            columns: [{
                    data: 'id',
                    name: 'id'
                },
