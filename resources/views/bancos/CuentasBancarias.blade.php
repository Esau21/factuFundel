...
@section('content')
            ...
            <div class="col-12">
                <div class="card h-100 d-flex flex-column">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Cuentas bancarias | {{ $banco?->nombre }}.</h5>
                        <div>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                data-bs-target="#addCuentaBancaria">Agregar cuenta bancaria</button>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="sysconta-datatable" class="display cell-border stripe hover order-column"
                                ...
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-left">Tipo cuenta</th>
    ...
    @include('bancos.modal.cuentasBancariasform')
    @include('bancos.modal.cuentasBancariasEdit')
@endsection
...
<script>
    $(document).ready(function() {
        ...
        $('#sysconta-datatable').DataTable({
            ...
            ajax: '{!! route('cuentas.indexGetCuentasBancarias', ':id') !!}'.replace(':id', bancoId),
            columns: [{
                    data: 'id',
                    name: 'id'
                },
