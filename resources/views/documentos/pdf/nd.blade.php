            ...
            <tr>
                <td colspan="2" class="p-2" style="width: 45%;">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div style="font-size: 10px; line-height: 1.3;">
                            ...
                            <div><strong>NRC:</strong> {{ $json['emisor']['nrc'] }} &nbsp;&nbsp;&nbsp;
                ...
                <td class="align-middle p-3" style="width: 40%;">
                    <div class="border border-dark p-3 rounded"
                        ...
                        <div class="fw-bold text-center mb-3">NOTA DE DÉBITO</div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['subTotal'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">13% IVA</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['tributos'][0]['valor'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">Sub-Total</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['montoTotalOperacion'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">(+)&nbsp;IVA
                                        Percibido</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['ivaPerci1'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">(-)&nbsp;IVA
                                        Retenido</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['ivaRete1'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">Ventas Exentas
                                    </td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['totalExenta'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">Ventas No
                                        Sujetas</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['totalNoSuj'], 2) }}</td>
                                </tr>
                                <tr>
                                    <td
