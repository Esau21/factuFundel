...
<body>
            ...
            <tr>
                <td colspan="2" class="p-2" style="width: 45%;">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div style="font-size: 10px; line-height: 1.3;">
                            ...
                            <div><strong>Web:</strong> www.tuempresa.com</div>
                        </div>
                    </div>
                </td>
                ...
                <td class="align-middle p-3" style="width: 40%;">
                    <div class="border border-dark p-3 rounded"
                        ...
                        <div class="fw-bold text-center mb-3">NOTA DE CRÉDITO</div>
            ...
            <table class="table table-bordered w-100 mb-0">
                ...
                <tr>
                    <td colspan="2" class="p-2">
                        <strong>DOCUMENTO RELACIONADO:</strong><br>
                        Tipo: {{ $json['documentoRelacionado'][0]['tipoDocumento'] }},
                        Fecha: {{ $json['documentoRelacionado'][0]['fechaEmision'] }},
                        Código Generación: {{ $json['documentoRelacionado'][0]['numeroDocumento'] }}
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div class="footer" style="border: none !important; font-size: 10px; line-height: 1.1;">
        <table class="table table-bordered mb-0"
            ...
            <tbody>
                <tr>
                    <td style="width: 75%; vertical-align: top; padding: 0.3rem 0.5rem; border-right: 1px solid black; text-align: left;">
                    ...
                    <td style="width: 25%; vertical-align: top; padding: 0;">
                        <table class="table table-sm table-borderless mb-0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">(+)&nbsp;IVA Percibido</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['ivaPerci1'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">(-)&nbsp;IVA Retenido</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['ivaRete1'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">Ventas Exentas</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['totalExenta'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; padding: 0.1rem 0.2rem;">Ventas No Sujetas</td>
                                    <td class="text-end" style="padding: 0.1rem 0.2rem;">
                                        ${{ number_format($json['resumen']['totalNoSuj'], 2) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-right: 1px solid black; font-weight: bold; padding: 0.1rem 0.2rem;">
                                        Total a Pagar
                                    </td>
